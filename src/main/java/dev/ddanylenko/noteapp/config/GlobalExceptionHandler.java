...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDto> handleInvalidTag(HttpMessageNotReadableException e) {
        logger.info("Handled exception", e);
        ErrorResponseDto errorResponseDto = new ErrorResponseDto("Invalid tags provided", e.getMessage(), LocalDateTime.now());
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(errorResponseDto);
    }
}
